using CustomerServiceChatBot.Models;
...
namespace CustomerServiceChatBot.Dialogs
{
    public class LMSDialog
    {
        public static readonly IDialog<string> dialog = Chain.PostToChain()
            ...
            {
                return Chain.ContinueWith(FormDialog.FromForm(LeaveManagementSystem.BuildForm, FormOptions.PromptInStart), AfterGreetingContinuation);
            }))
            .Unwrap()
            .PostToUser();
